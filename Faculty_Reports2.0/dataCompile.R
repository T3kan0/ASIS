...
#***** Data Prep: Changing column names to maatch before combining the attendance and performance files
...
#**** Filtering data according info we need...

mark <- mark%>%select(Module.Code,Attendee,FACULTY,Campus,FINAL.MARK)
